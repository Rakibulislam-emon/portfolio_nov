...
export const HERO_CONTENT = `Passionate about creating visually appealing, high-performance web applications, I specialize in building responsive, user-focused interfaces with React and JavaScript. With a commitment to clean code and modern design, I transform complex ideas into intuitive, impactful digital experiences that help brands connect and grow. Let’s collaborate to bring your vision to life with a website that stands out.
...
export const projects = [
  ...
  },
  {
      title: "Flex-Fitness",
      image: project1,
      githubLink: "https://github.com/Rakibulislam-emon/Flex-Fitness?tab=readme-ov-file",
      liveLink: "https://fit-gym-7bce5.web.app/",
